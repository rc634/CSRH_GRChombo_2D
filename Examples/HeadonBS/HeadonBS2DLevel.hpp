...
#ifndef HEADONBS2DLEVEL_HPP_
#define HEADONBS2DLEVEL_HPP_
...
class HeadonBS2DLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<HeadonBS2DLevel>;
