...
double BosonStarSolution::get_ADMmass() const { return adm_mass; }
...
{
    gridsize = m_params_BosonStar.BS_gridpoints;
    adaptive_buffer =
    ...
    PC = m_params_BosonStar.BS_amplitude;
    EIGEN = m_params_BosonStar.BS_eigen;
